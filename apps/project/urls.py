...
urlpatterns = [
                  ...
                  path('<uuid:pk>/ground_truth/', include('apps.project.project_ground_truth.urls'), name='ground_truth'),
                  path('<uuid:pk>/my_data_ground_truth/', views.SetGroundTruthOfMyData.as_view(), name='my_data_ground_truth'),
                  path('<uuid:pk>/my_data_ground_truth/action/', views.SetGroundTruthOfMyDataAction.as_view(), name='my_data_ground_truth_action'),
                  ...
                  path('<uuid:pk>/transfers/<uuid:job_pk>/', view=views.TransferJobDetailView.as_view(), name='transfer-job'),
                  path('<uuid:pk>/transfers/<uuid:job_pk>/action/', view=views.TransferJobDetailActionView.as_view(), name='transfer-job-action'),
                  ...
                  path('<uuid:pk>/download-query/', view=views.DownloadFilesActionView.as_view(), name='download-query'),
                  ...
                  path('<uuid:pk>/share/query/action/', view=views.CreateShareQueryActionView.as_view(), name='create-share-query-action'),
                  ...
                  path('<uuid:pk>/shares/<uuid:share_pk>/action/', view=views.ShareDetailActionView.as_view(), name='share-detail-action'),
...
path('<uuid:pk>/export/', view=views.ExportAsCSVView.as_view(),
                ...
                path('<uuid:pk>/collaborators/delete/', view=views.DeleteCollaboratorActionView.as_view(), name="collaborator-delete"),
