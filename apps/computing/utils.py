...
# https://github.com/mlflow/mlflow/blob/d0f763db611251af00d49cfa82bc38e1baf10200/mlflow/utils/name_utils.py
def _generate_string(sep, integer_scale):
    ...
    return f"{predicate}{sep}{noun}{sep}"
...
def _generate_random_name(sep="-", integer_scale=3, max_length=20):
    ...
    for _ in range(10):
        ...
        if len(name) <= max_length:
            return name[:-1]  # return without last separator
